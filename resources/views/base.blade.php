        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="/dashboard_assets/index.html" class="nav-item nav-link active">Home</a>
                    <a href="/dashboard_assets/category.html" class="nav-item nav-link">Categories</a>
                    <a href="/dashboard_assets/single.html" class="nav-item nav-link">Single News</a>
